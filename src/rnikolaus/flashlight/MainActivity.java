...
public class MainActivity extends ActionBarActivity {
	...
	/**
	 * This will flash out the pattern described by the Boolean list
	 * One timeunit has a duration of 100 ms
	 * @param signals
	 */
	...
	/**
	 * Turns the content of the editText into a signal pattern and plays #
	 * it through the camera flash
	 * @param v
	 */
	public void flash(View v) {
		EditText editText= (EditText)findViewById(R.id.editText1);
		Morse morse = new Morse();
		List<Boolean> signals = morse.messageToSignal(editText.getText().toString());
